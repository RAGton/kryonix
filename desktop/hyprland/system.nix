...
in
{
  config = lib.mkIf isHyprland {
    ...
    programs.zsh.loginShellInit = lib.mkIf (config.rag.desktop.directLogin.enable) (lib.mkAfter ''
    ...
    environment.systemPackages = with pkgs; [
      ...
      hyprlandNoNixGL
        ...
        (writeShellApplication {
          name = "grimblast";
          runtimeInputs = [ bash coreutils grim slurp wl-clipboard libnotify jq hyprlandNoNixGL ];
          text = ''
            set -euo pipefail
