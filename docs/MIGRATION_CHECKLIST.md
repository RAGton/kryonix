...
- [x] **SEMPRE** rodar `nix flake check` após mudança
...
**Status**: ✅ CONCLUÍDA (desktop/manager.nix ativo e `nix flake check` passando)
...
# Aplicar HM do usuário principal (rocha)
